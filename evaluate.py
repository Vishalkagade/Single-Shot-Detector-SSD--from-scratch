...
parser.add_argument('--file_directory' , help = 'images_and_labels_path',default=r"C:\Users\Vishal Kagade\Documents\Data Augemnetation\annotations")
parser.add_argument('--number_of_classes' , help = 'no_of_classes',default=3)
...
train_set, test_Set = torch.utils.data.random_split(dataset, [4,1])
...
def compute_loss(output_classes, target_classes, output_boxes, target_boxes, device):
    ...
    for i_batch in range(n_batch):
        ...
        positive_mask = target_classes[i_batch][:] > 0 #check if there is any class in those 8732 boxes
